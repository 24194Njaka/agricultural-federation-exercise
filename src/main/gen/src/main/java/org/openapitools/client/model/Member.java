...
public class Member {
  ...
  /**
   * List of sponsors who parrained this member
   * @return referees
   */
  @javax.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, occupation, referees, firstName, lastName, birthDate, gender, address, profession, phoneNumber, email);
  }
